...
public class AlarmEjercicioReceiver extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
        String event = intent.getStringExtra("eventE");
        String time  = intent.getStringExtra("timeE");
        int notId = intent.getIntExtra("idE", 0);
